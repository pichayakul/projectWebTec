	...
	<div class="navbar navbar-default" style="background-color: white; box-shadow:0 0 10px;">
		...
		<div class="col-sm-2 navbar-header">
			<form id="name-website-form" method="POST" action="./home.php" style="">
				<a  id="name-website"  href="home.php" onclick="document.getElementById('name-website-form').submit(); " class="navbar-brand" style="font-size:24px;">The Garden</a>
			</form>
		</div>
		...
		<!-- <div class="col-sm-2"> -->
			...
			<div class="dropdown">
			  ...
			  <ul class="dropdown-menu">
			    <li><a class="" href="./viewprofile.php">View profile</a></li>
			    <li><a class="" href="./viewevent.php">View event</a></li>
			    <li><a class=" <?php if($_SESSION['position']!="admin"){ echo "noshow";} ?>" href="./management.php" >Management</a></li>
	...
	<div id="login-myModal" class="modal fade" role="dialog">
	  <div class="modal-dialog">
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body  clearfix ml-4 mr-4" id="login-content">
	      	<br>
	      ...
	      <div class="modal-body  clearfix ml-4 mr-4 noshow" id="forget-content">
	      	...
	      	<form id="forget-form" method="post" action="">
	      		<div class="form-group">
		      		...
		      		<label id="forget-alert-email" class="noshow" style="color:red;">---Email is already used.---</label>
	      		</div>
	      		<label id="alert-login" class="noshow" style="color:red;">username or password are wrong.</label>
	      		<br>
