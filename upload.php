...
if ((isset($_POST["btnSetting"]) || isset($_POST["btnCreate"])) && isset($_POST["username"]) ){
    ...
    echo count(var_dump($_FILES));
    if (!empty($_FILES["vdoUpload"])){
        ...
        //     $uploadOk = 0;
        //  }
        if ($_FILES["vdoUpload"]["type"] == "video/mp4") {
    ...
    if (!empty($_FILES["fileToUpload"])){
        foreach($_FILES["fileToUpload"]["name"] as $i){
...
else if (isset($_POST["submitM"]) && !isset($_POST["free"])){
    echo "noasdasasdasdasdasdsadasdasd";
    $username=$_POST["username"];
    $title=$_POST["title"];
