...
<div class="col-sm-8" >
  <div id="wallTopic" class="col-sm-12">
  <h1>
    <a href=""  style="font-size: 3em;"  class="typewrite" data-period="3000" data-type='[ "Webboard." ]'>
...
<?php
  ...
  if (isset($index["username"]) && isset($_SESSION["username"])){
    if ($index["username"] == $_SESSION['username'] ){
        ?>
